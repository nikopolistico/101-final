...
export default {
  ...
  { id: "1", barangays: [
    "Bangcasi Airport", "Dumalagan Butuan", "J.C Aquino Avenue", "A.D. Curato St. Butuan", "Durano St. Butuan", "T. Calo St.Butuan"
  ]},
  { id: "2", barangays: [
    "Bangcasi", "Dumalagan", "J.C Aquino Avenue", "North Montilla Blvd", "T. Calo St.Butuan", "J.C Aquino Ave", "Dumalagan"
  ]},
  { id: "4", barangays: [
    "Bangcasi", "Dumalagan", "J.C Aquino Avenue", "A. D. Curato St. Butuan", "T. Sanchez St. Butuan", "M. Calo St.", "G. Flores St. Butuan", 
    "Rosales St.", "North Montilla Blvd.", "BOPAI Puregold Butuan Tabuan", "Holy Redeemer", "Butuan City Hall", "Gaisano Butuan", 
    "J. C. Aquino Butuan", "Dumalagan"
  ]},
  { id: "8", barangays: [
    "Sto. Nino Diocesan Shrine", "Los Angeles Butuan City", "Sumilihon Butuan City", "Taguibo", "Ampayon", "Philippine Science High School Butuan", 
    "Tiniwisan", "Baan Butuan City", "J.C. Aquino Ave.", "J. Rosales St.", "Butuan City Hall", "J. Satorre St.", "Jeels Masagana Farm", 
    "Salvador Calo St.", "Langihan Public Market", "Magsaysay St. Butuan", "Andaya St.", "North Montilla Blvd.", "McDonald's Butuan Downtown", 
    "R. Calo St.", "T. Sanchez St.", "M. Calo St.", "Baan Viaduct", "Baan Km. 3", "Ampayon", "Taguibo", "Sumilihon"
  ]},
  { id: "12", barangays: [
    "Amparo Butuan", "Bit-os", "Gaisano Butuan", "San Vicente Butuan City", "Montilla Blvd. Butuan", "Holy Redeemer", "City Hall", "Mandacpan Butuan City"
  ]},
  { id: "13", barangays: [
    "Banza National High School Butuan", "Brgy. Maug Butuan City", "Mahogany Butuan City", "Baan Butuan", "M. Calo St. Butuan", "G. Flores Avenue Butuan", 
    "Rosales St. Butuan City", "North Montilla Blvd.", "Obrero Elem. School", "Langihan Public Market", "Butuan City Hall", "J. Rosales St.", 
    "J. C. Aquino Ave. (DBP)", "Baan Viaduct", "Brgy. Mahogany", "Brgy. Maug", "Brgy. Banza"
  ]},
  { id: "10", barangays: [
    "Dumalagan Butuan", "J.C. Aquino Ave. Butuan", "Baan Butuan", "Baan Km. 3", "Tiniwisan Butuan", "Philippine Science High School Butuan", "Ampayon", 
    "Vice Versa"
  ]},
  { id: "7", barangays: [
    "De Oro Butuan", "Taligaman Butuan", "Antongalon Elem. School Butuan", "LTFRB Butuan", "Ampayon Butuan", "Caraga State University", 
    "Philippine Science High School Butuan", "Tiniwisan Butuan", "Butuan Medical Center", "Baan Butuan", "M. Calo St.", "G. Flores St.", 
    "North Montilla Blvd. Butuan", "Andaya St. Butuan", "Langihan Public Market", "Butuan City Hall", "Development Bank Of The Philippines", 
    "SM Butuan", "R. Calo St. Butuan", "T. Sanchez St. Butuan", "M. Calo St. Butuan", "Baan Viaduct Butuan", "Baan Km. 3", "Tiniwisan Butuan", 
    "Ampayon", "Antongalon Butuan", "Taligaman Butuan"
  ]},
  { id: "14", barangays: [
    "Ampayon Butuan City", "Tiniwisan Butuan City", "Alviola Butuan City", "ERA STORE Butuan City", "Lemon Butuan City", "Pigdaulan Butuan City", 
    "Mahay Butuan City", "San Vicente Butuan City", "Montilla Boulevard", "SM Butuan City", "Gaisano Butuan City", "Robinsons Butuan City"
  ]},
    ...
    const getCoordinatesFromGeocodingAPI = async (location) => {
      const url = `https://nominatim.openstreetmap.org/search?q=${encodeURIComponent(location + " Butuan City")}&format=json&limit=1`;
  ...
  try {
    ...
    for (const route of routes) {
      const barangays = route.barangays.map(b => b.trim().toLowerCase());
      // Check if any barangay in the route is part of the start and end location
      if (barangays.some(b => b.includes(start)) && barangays.some(b => b.includes(end))) {
...
.info-card {
  ...
  position: relative;
  z-index: 2;
  background: transparent; /* Slightly white glass effect */
  border-radius: 12px;
  padding: 20px;
...
.fade-enter-active, .fade-leave-active {
  transition: opacity 1s ease-in-out; /* Increased duration to 1s */
}
...
.fade-enter, .fade-leave-to {
  animation: fadeIn 1.5s ease-out forwards; /* Slow fade-in with easing */
}
